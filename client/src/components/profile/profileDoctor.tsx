...
import { ProfileDoctor } from "../../interfaces/interfaces"
...
export const ProfileDoctorComp = (props: dataProp) => {

    const { name, phone, email, especialidad, role, status } = props.data
    ...
    return(
        <SafeAreaView style={styleProfile.container}>
            ...
            <Text><Text style={styleProfile.text}>Especialidad: </Text>{especialidad}</Text>
